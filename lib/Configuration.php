...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.criteo.com/marketing';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.0.0-alpha/PHP';
    ...
    {
        $report  = 'PHP SDK (Criteo\Marketing) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v.1.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.0-alpha' . PHP_EOL;

...
class StatisticsApi
{
     ...
     * @param  \Criteo\Marketing\Model\CampaignReportQueryMessage $report_query report_query (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     */
    public function getCampaignReport($authorization, $report_query)
    {
        list($response) = $this->getCampaignReportWithHttpInfo($authorization, $report_query);
        return $response;
    }
     ...
     *
     * @param  string $authorization JWT Bearer Token (required)
     * @param  \Criteo\Marketing\Model\CampaignReportQueryMessage $report_query (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignReportWithHttpInfo($authorization, $report_query)
    {
        $request = $this->getCampaignReportRequest($authorization, $report_query);
     ...
     */
    public function getCampaignReportAsync($authorization, $report_query)
    {
        return $this->getCampaignReportAsyncWithHttpInfo($authorization, $report_query)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignReportAsyncWithHttpInfo($authorization, $report_query)
    {
        $returnType = 'string';
        $request = $this->getCampaignReportRequest($authorization, $report_query);
     ...
     */
    protected function getCampaignReportRequest($authorization, $report_query)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling getCampaignReport'
            );
        }
        // verify the required parameter 'report_query' is set
        if ($report_query === null || (is_array($report_query) && count($report_query) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $report_query when calling getCampaignReport'
            );
        }

        $resourcePath = '/v1/statistics/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($report_query)) {
            $_tempBody = $report_query;
        }

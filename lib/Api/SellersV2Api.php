...
class SellersV2Api
{
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\AdvertiserQuotaMessage[]
     */
    public function getAdvertiserPreviewLimits($authorization)
    {
        list($response) = $this->getAdvertiserPreviewLimitsWithHttpInfo($authorization);
        return $response;
    }
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\AdvertiserQuotaMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserPreviewLimitsWithHttpInfo($authorization)
    {
        $request = $this->getAdvertiserPreviewLimitsRequest($authorization);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\AdvertiserQuotaMessage[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\AdvertiserQuotaMessage[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Criteo\Marketing\Model\AdvertiserQuotaMessage[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\AdvertiserQuotaMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvertiserPreviewLimitsAsync($authorization)
    {
        return $this->getAdvertiserPreviewLimitsAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvertiserPreviewLimitsAsyncWithHttpInfo($authorization)
    {
        $returnType = '\Criteo\Marketing\Model\AdvertiserQuotaMessage[]';
        $request = $this->getAdvertiserPreviewLimitsRequest($authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAdvertiserPreviewLimitsRequest($authorization)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling getAdvertiserPreviewLimits'
            );
        }

        $resourcePath = '/v2/crp/advertisers/preview-limit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  bool $with_balance with_balance (optional)
     * @param  bool $with_spend with_spend (optional)
     * @param  \DateTime $end_after_date end_after_date (optional)
     * @param  \DateTime $start_before_date start_before_date (optional)
     * @param  int $budget_id budget_id (optional)
     * @param  int $seller_id seller_id (optional)
     ...
     * @return \Criteo\Marketing\Model\SellerBudgetMessage[]
     */
    public function getBudgetsByAdvertiser($advertiser_id, $authorization, $status = null, $with_balance = null, $with_spend = null, $end_after_date = null, $start_before_date = null, $budget_id = null, $seller_id = null, $type = null)
    {
        list($response) = $this->getBudgetsByAdvertiserWithHttpInfo($advertiser_id, $authorization, $status, $with_balance, $with_spend, $end_after_date, $start_before_date, $budget_id, $seller_id, $type);
        return $response;
    }
     ...
     * @param  bool $with_balance (optional)
     * @param  bool $with_spend (optional)
     * @param  \DateTime $end_after_date (optional)
     * @param  \DateTime $start_before_date (optional)
     * @param  int $budget_id (optional)
     ...
     * @return array of \Criteo\Marketing\Model\SellerBudgetMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getBudgetsByAdvertiserWithHttpInfo($advertiser_id, $authorization, $status = null, $with_balance = null, $with_spend = null, $end_after_date = null, $start_before_date = null, $budget_id = null, $seller_id = null, $type = null)
    {
        $request = $this->getBudgetsByAdvertiserRequest($advertiser_id, $authorization, $status, $with_balance, $with_spend, $end_after_date, $start_before_date, $budget_id, $seller_id, $type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBudgetsByAdvertiserAsync($advertiser_id, $authorization, $status = null, $with_balance = null, $with_spend = null, $end_after_date = null, $start_before_date = null, $budget_id = null, $seller_id = null, $type = null)
    {
        return $this->getBudgetsByAdvertiserAsyncWithHttpInfo($advertiser_id, $authorization, $status, $with_balance, $with_spend, $end_after_date, $start_before_date, $budget_id, $seller_id, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBudgetsByAdvertiserAsyncWithHttpInfo($advertiser_id, $authorization, $status = null, $with_balance = null, $with_spend = null, $end_after_date = null, $start_before_date = null, $budget_id = null, $seller_id = null, $type = null)
    {
        $returnType = '\Criteo\Marketing\Model\SellerBudgetMessage[]';
        $request = $this->getBudgetsByAdvertiserRequest($advertiser_id, $authorization, $status, $with_balance, $with_spend, $end_after_date, $start_before_date, $budget_id, $seller_id, $type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBudgetsByAdvertiserRequest($advertiser_id, $authorization, $status = null, $with_balance = null, $with_spend = null, $end_after_date = null, $start_before_date = null, $budget_id = null, $seller_id = null, $type = null)
    {
        // verify the required parameter 'advertiser_id' is set
        if ($advertiser_id === null || (is_array($advertiser_id) && count($advertiser_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling getBudgetsByAdvertiser'
            );
        }

        $resourcePath = '/v2/crp/advertisers/{advertiserId}/budgets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($budget_id !== null) {
            $queryParams['budgetId'] = ObjectSerializer::toQueryValue($budget_id);
        }
        // query params
        if ($seller_id !== null) {
     ...
     * @return string
     */
    public function getSellerAdDemo($advertiser_id, $seller_id, $authorization, $campaign_id = null, $height = null, $width = null)
    {
        list($response) = $this->getSellerAdDemoWithHttpInfo($advertiser_id, $seller_id, $authorization, $campaign_id, $height, $width);
        return $response;
    }
     ...
     */
    public function getSellerAdDemoWithHttpInfo($advertiser_id, $seller_id, $authorization, $campaign_id = null, $height = null, $width = null)
    {
        $request = $this->getSellerAdDemoRequest($advertiser_id, $seller_id, $authorization, $campaign_id, $height, $width);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerAdDemoAsync($advertiser_id, $seller_id, $authorization, $campaign_id = null, $height = null, $width = null)
    {
        return $this->getSellerAdDemoAsyncWithHttpInfo($advertiser_id, $seller_id, $authorization, $campaign_id, $height, $width)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerAdDemoAsyncWithHttpInfo($advertiser_id, $seller_id, $authorization, $campaign_id = null, $height = null, $width = null)
    {
        $returnType = 'string';
        $request = $this->getSellerAdDemoRequest($advertiser_id, $seller_id, $authorization, $campaign_id, $height, $width);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSellerAdDemoRequest($advertiser_id, $seller_id, $authorization, $campaign_id = null, $height = null, $width = null)
    {
        // verify the required parameter 'advertiser_id' is set
        if ($advertiser_id === null || (is_array($advertiser_id) && count($advertiser_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling getSellerAdDemo'
            );
        }

        $resourcePath = '/v2/crp/advertisers/{advertiserId}/ad-preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Criteo\Marketing\Model\SellerCampaignMessage[]
     */
    public function getSellerCampaignsByAdvertiser($advertiser_id, $authorization)
    {
        list($response) = $this->getSellerCampaignsByAdvertiserWithHttpInfo($advertiser_id, $authorization);
        return $response;
    }
     ...
     * @return array of \Criteo\Marketing\Model\SellerCampaignMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSellerCampaignsByAdvertiserWithHttpInfo($advertiser_id, $authorization)
    {
        $request = $this->getSellerCampaignsByAdvertiserRequest($advertiser_id, $authorization);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerCampaignsByAdvertiserAsync($advertiser_id, $authorization)
    {
        return $this->getSellerCampaignsByAdvertiserAsyncWithHttpInfo($advertiser_id, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerCampaignsByAdvertiserAsyncWithHttpInfo($advertiser_id, $authorization)
    {
        $returnType = '\Criteo\Marketing\Model\SellerCampaignMessage[]';
        $request = $this->getSellerCampaignsByAdvertiserRequest($advertiser_id, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSellerCampaignsByAdvertiserRequest($advertiser_id, $authorization)
    {
        // verify the required parameter 'advertiser_id' is set
        if ($advertiser_id === null || (is_array($advertiser_id) && count($advertiser_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling getSellerCampaignsByAdvertiser'
            );
        }

        $resourcePath = '/v2/crp/advertisers/{advertiserId}/seller-campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

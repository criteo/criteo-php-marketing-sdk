...
class InlineResponse200 implements ModelInterface, ArrayAccess
{
     ...
     * Sets access_token
     *
     * @param string|null $access_token JWT to be used in to authenticate requests.
     *
     * @return $this
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Expiration time express in seconds.
     *
     * @return $this
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type Always bearer.
     *
     * @return $this
     */
